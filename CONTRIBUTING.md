# Contributing to soulsynth

Thank you for your interest in contributing to soulsynth! This document provides guidelines and instructions for contributing to this project.
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/soulsynth.git
   cd soulsynth
   ```
3. **Add the upstream remote**:
   ```bash
   git remote add upstream https://github.com/igor-kan/soulsynth.git
   ```
...
By contributing to soulsynth, you agree that your contributions will be licensed under the project's [MIT License](LICENSE).
